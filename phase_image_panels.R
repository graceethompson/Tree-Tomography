...
base_dir <- "from jon - HarvardForest_Tomography"
sot_dir  <- file.path(base_dir, "SoTs Percentage")
ert_norm_dir <- file.path(base_dir, "ERTs_Absolute")
ert_abs_dir  <- file.path(base_dir, "ERTs_Absolute")
...
make_image_panel(dat, "quad_A", "neg_median_spp_site_z", ert_thresh_A,
                 ...
                 "panel_A_neg_median_spp_site_znorm.pdf")
...
make_image_panel(dat, "quad_D", "cma_spp_site_z", ert_thresh_D,
                 ...
                 "panel_D_cma_spp_site_znorm.pdf")
...
pdf("phase_diagrams_by_species.pdf", width = 14, height = 10)
