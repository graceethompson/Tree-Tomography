...
pdf("output/figures/phase_diagram_candidates.pdf", width = 14, height = 8)
...
write_csv(results %>% arrange(desc(composite)),
          "output/tables/phase_diagram_results.csv")
...
pdf("output/figures/phase_diagram_kmeans.pdf", width = 14, height = 8)
