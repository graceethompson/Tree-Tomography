...
# Load ERT results
ert_raw <- read_csv("data/hemlock/ERT_results_2026-03-05.csv", show_col_types = FALSE)
...
ggsave("output/hemlock_figures/fig_scatter_dbh.pdf", fig1, width = 14, height = 8)
...
ggsave("output/hemlock_figures/fig_scatter_by_height.pdf", fig2, width = 22, height = 12)
...
ggsave("output/hemlock_figures/fig_scatter_avg.pdf", fig3, width = 14, height = 8)
...
pdf("output/hemlock_figures/fig_correlation_heatmap.pdf", width = 10, height = 6)
pheatmap(
  heat_mat,
...
make_pca_biplot(ert_dbh, "PCA of ERT Metrics — DBH (n = 12)", "output/hemlock_figures/fig_pca_biplot.pdf")

# 5b: PCA biplot — all heights pooled
make_pca_biplot(ert, "PCA of ERT Metrics — All Heights Pooled", "output/hemlock_figures/fig_pca_biplot_all.pdf")
...
ggsave("output/hemlock_figures/fig_best_predictor.pdf", fig6, width = 6, height = 5, device = cairo_pdf)
...
ggsave("output/hemlock_figures/fig_rank_comparison.pdf", fig7, width = 8, height = 6)
...
ggsave("output/hemlock_figures/fig_vertical_variation.pdf", fig8, width = 12, height = 10)
...
pdf("output/hemlock_figures/fig_metric_redundancy.pdf", width = 8, height = 7)
pheatmap(
  cor_metrics,
...
write_csv(summary_table, "data/hemlock/validation_summary.csv")
